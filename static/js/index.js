...
$( '#toggle-dark-mode' ).click( function ()
{
  ...
  document.getElementById('toggle-light-mode').hidden= false;
  document.getElementById('toggle-dark-mode').hidden = true;
} )

$('#toggle-light-mode').click( function (){
  document.body.classList.remove('dark');
  document.getElementById( 'toggle-light-mode' ).hidden = true;
  document.getElementById( 'toggle-dark-mode' ).hidden = false;
})
